...
INPUT_PATTERNS_CONFIG = {
    ...
    "pattern_type": {
        ...
        "display_options": ["Poisson Spike Trains", "Rhythmic Oscillations", "Burst Stimulation", "Step Current"],
    ...
    "poisson_rate": {
        ...
        "depends_on": {"pattern_type": "poisson"}
    },
    "poisson_weight": {
    ...
    "rhythmic_frequency": {
        ...
        "depends_on": {"pattern_type": "rhythmic"}
    },
    "rhythmic_amplitude": {
