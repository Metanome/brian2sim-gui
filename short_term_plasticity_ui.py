...
def create_short_term_plasticity_group(main_window):
    ...
    main_window.short_term_plasticity_form_generator = ShortTermPlasticityFormGenerator(SHORT_TERM_PLASTICITY_CONFIG)
        ...
        for param_key, widget in param_widgets.items():
            if param_key != "enabled":
                if hasattr(widget, 'valueChanged'):
                    widget.valueChanged.connect(main_window.short_term_plasticity_manager.on_param_changed)
                elif hasattr(widget, 'currentIndexChanged'):
                    widget.currentIndexChanged.connect(main_window.short_term_plasticity_manager.on_param_changed)
...
class ShortTermPlasticityFormGenerator(BaseFormGenerator):
    ...
    def _create_forms(self):
        ...
        # Create the params group widget that will contain the grid of parameters
