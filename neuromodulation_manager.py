...
from neuromodulation_config import NEUROMODULATION_CONFIG, NEUROMODULATION_RESEARCH_INFO
    ...
    def estimate_network_effects(self, params):
        ...
        if params.get('dopamine_system', False):
            ...
            if net_da_effect > 0.05:
                effects['dopamine_prediction'] = "Strong dopaminergic modulation - expect enhanced plasticity"
            else:
        ...
        if params.get('acetylcholine_system', False):
            ...
            if net_ach_effect > 0.02:
                effects['acetylcholine_prediction'] = "Strong cholinergic modulation - expect enhanced attention/learning"
            else:
