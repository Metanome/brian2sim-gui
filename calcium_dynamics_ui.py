...
from calcium_dynamics_config import CALCIUM_DYNAMICS_CONFIG
...
def create_calcium_dynamics_group(main_window):
    ...
    main_window.calcium_dynamics_form_generator = CalciumDynamicsFormGenerator(CALCIUM_DYNAMICS_CONFIG)
        ...
        for param_key, widget in param_widgets.items():
            if param_key != "enabled":  # Don't connect the main enable checkbox
                if hasattr(widget, 'valueChanged'):
                    widget.valueChanged.connect(main_window.calcium_dynamics_manager.on_param_changed)
                elif hasattr(widget, 'currentIndexChanged'):
                    widget.currentIndexChanged.connect(main_window.calcium_dynamics_manager.on_param_changed)
