from PyQt6.QtWidgets import (
    QGroupBox, QVBoxLayout, QPushButton, QHBoxLayout, QLabel, QComboBox
)
...
def create_scenario_presets_group(main_window):
    ...
    main_window.scenario_preset_combo.setToolTip("Quickly set parameters for common scenarios. Overrides current settings.")
