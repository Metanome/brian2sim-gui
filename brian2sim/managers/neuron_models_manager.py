            ...
            if model_config and "presets" in model_config:
                ...
                if preset and "values" in preset:
                    ...
                    if "noise_options" in preset:
                        self.main_window.noise_options_manager.apply_preset_values(
                            preset["noise_options"]
                        )
                    if "network_options" in preset:
                        self.main_window.network_options_manager.apply_preset_values(
                            preset["network_options"]
                        )
        finally:
