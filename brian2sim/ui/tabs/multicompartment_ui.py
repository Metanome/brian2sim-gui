...
def create_multicompartment_group(main_window):
    ...
    main_window.multicompartment_form_generator = MulticompartmentFormGenerator(
        MULTICOMPARTMENT_CONFIG
    )
    # Alias for simulation_manager compatibility
    main_window.multicompartment_ui = main_window.multicompartment_form_generator
            ...
            if param_key != "enabled":
                if hasattr(widget, "valueChanged"):
                    widget.valueChanged.connect(
                        main_window.multicompartment_manager.on_param_changed
                    )
