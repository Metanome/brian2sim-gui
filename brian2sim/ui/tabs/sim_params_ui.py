...
def _add_param_to_sim_grid_in_ui(main_window, grid_layout, label_text, widget):
    ...
    main_window._add_param_to_grid_layout(
        grid_layout, label_text, widget, main_window.sim_params_num_cols, temp_pos_tracker
    )
...
def create_simulation_parameters_group(main_window):
    ...
    if form_widget:
        ...
        main_window.lif_reset_value = (
            -70.0
        )  # Typical reset potential        # Legacy grid layout support for LIF parameter insertion
