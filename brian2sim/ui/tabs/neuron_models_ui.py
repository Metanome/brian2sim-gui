...
from PyQt6.QtWidgets import QComboBox, QGroupBox, QHBoxLayout, QLabel, QStackedWidget, QVBoxLayout

from brian2sim.models.neuron_models_config import NEURON_MODELS_CONFIG
from brian2sim.ui.ui_forms import NeuronModelFormGenerator
...
def create_neuron_model_group(main_window):
    ...
    main_window.neuron_model_combo.setToolTip(
        "Select the type of neuron model to use for the simulation."
    )
    ...
    main_window.neuron_model_preset_combo.setToolTip(
        "Select a preset to quickly apply common parameter values."
    )
