...
def create_simulation_controls_group(main_window):
    ...
    main_window.run_simulation_button.setToolTip(
        "Execute the neural network simulation with current parameters"
    )
    main_window.run_simulation_button.clicked.connect(
        main_window.simulation_manager.start_simulation
    )
    ...
    main_window.stop_simulation_button.clicked.connect(
        main_window.simulation_manager.stop_simulation
    )
    ...
    main_window.reset_simulation_button.clicked.connect(
        main_window.simulation_manager.reset_simulation
    )
    ...
    main_window.auto_plot_checkbox.setToolTip(
