...
class CrossTabDependencyManager(QObject):
    ...
    def validate_configuration(self):
        ...
        if nmda_enabled and not ca_enabled:
            warnings.append("NMDA receptors are enabled but calcium dynamics are disabled. "
        ...
        if hp_enabled and (target_rate is None or target_rate <= 0):
            warnings.append("Homeostatic plasticity is enabled but target firing rate is not set properly.")
